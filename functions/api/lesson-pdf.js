...
export async function onRequestGet(context) {
  ...
  if (!id || !Number.isInteger(start) || !Number.isInteger(end) || start < 1 || end < start || end - start > 50) {
  ...
  return new Response(pdf, {
    headers: {
      ...
      "Content-Disposition": `inline; filename="singapore-math-pages-${start}-${safeEnd}.pdf"`,
